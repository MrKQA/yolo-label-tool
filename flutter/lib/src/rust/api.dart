...
// These functions are ignored because they are not marked as `pub`: `ai_annotate_image_from_json_request`, `ai_annotate_images_from_json_request`, `ai_model_classes_from_json_request`, `cam_analysis_from_json_request`, `clamp_percent`, `count_images_with_prefix`, `decode_video_frame_with_args`, `detect_best_hardware_decoder`, `detect_best_nvidia_gpu`, `detect_from_json_request`, `detect_images_from_json_request`, `detect_model_task_from_json_request`, `detect_model_task_result_json`, `detect_result_json`, `ensure_existing_video`, `error_json`, `export_model_from_json_request`, `ffmpeg_hwaccels`, `find_ffmpeg_near_project`, `find_ffmpeg_on_path`, `find_ffmpeg`, `find_ffprobe_near_project`, `find_ffprobe_next_to_ffmpeg`, `find_ffprobe_on_path`, `find_ffprobe`, `finite_json_number`, `has_intel_gpu`, `jpeg_quality_to_qscale`, `json_bool_field`, `json_escape`, `json_f64_field`, `json_raw_scalar`, `json_string_field`, `json_u32_field`, `json_value_start`, `optional_json_number`, `parse_frame_rate`, `parse_json_string_from_last_line`, `parse_nvidia_gpu_line`, `parse_percent_number`, `parse_positive_f64`, `parse_positive_or_zero_f64`, `probe_video_playback_info`, `python_string_literal_for_api`, `query_nvidia_resource_usage`, `required_json_string`, `sanitize_file_stem`, `sanitize_output_dir`, `string_from_ffi`, `training_resource_usage_json`, `vec_into_ffi_buffer`, `video_playback_info_json`
...
// These functions are ignored (category: IgnoreBecauseExplicitAttribute): `rust_label_ai_annotate_image_json`, `rust_label_ai_annotate_images_json`, `rust_label_ai_model_classes_json`, `rust_label_analyze_cam_json`, `rust_label_collab_command_json`, `rust_label_collab_poll_json`, `rust_label_db_append_logs_json`, `rust_label_db_delete_config_json`, `rust_label_db_delete_logs_json`, `rust_label_db_load_config_json`, `rust_label_db_load_snapshot_json`, `rust_label_db_log_dates_json`, `rust_label_db_overview_json`, `rust_label_db_read_logs_json`, `rust_label_db_save_config_json`, `rust_label_db_save_snapshot_json`, `rust_label_db_sql_query_json`, `rust_label_db_table_json`, `rust_label_decode_video_frame_png`, `rust_label_delete_training_logs_json`, `rust_label_detect_images_json`, `rust_label_detect_json`, `rust_label_detect_model_task_json`, `rust_label_export_model_json`, `rust_label_free_byte_buffer`, `rust_label_preload_yolo_python_json`, `rust_label_read_training_log_json`, `rust_label_shutdown_python_json`, `rust_label_training_log_dates_json`, `rust_label_training_log_tail_json`, `rust_label_training_resource_usage_json`, `rust_label_video_info_json`
